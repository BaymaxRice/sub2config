...
func DefaultConf() GenConfig {
	Settings := make(GenConfig)

	//default settings
	Settings["loglevel"] = "info"
	Settings["socksPort"] = "1086"
	Settings["udp"] = "true"
	Settings["httpPort"] = "12333"
...
func GenV2RayConf(conf GenConfig, template ...[]byte) ([]byte, error) {
	v2rayConf := ConfigTpl
	if len(template) > 0 {
		if len(template) != 1 {
